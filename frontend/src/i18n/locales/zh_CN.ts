  ...
  test_track: {
    ...
    case: {
      ...
      import: {
        ...
        click_upload: '点击上传',
        upload_limit: '支持: 只能上传xls/xlsx文件，大小不超过100M',
        upload_xmind: '支持: xmind格式文件, 一次至多导入800条用例',
        ...
        import_by_excel: '从Excel表格导入测试用例',
        import_by_xmind: '从思维导图导入测试用例',
        download_template_tips_please: '请先  ',
        download_template_tips_fill_upload_tips: '  ,  填写后上传',
        import_type: '导入类型',
        import_select_version: '选择版本',
        import_upload_drag_tips: '拖拽或点击此区域选择文件',
        import_change_file: '更换文件',
        import_uploading_tips: '文件上传中',
    ...
    issue: {
      ...
      close_success: '关闭成功',
      delete_warning: '解除会影响测试计划相关统计，确定取消吗？',
      preview: '预览',
      status_new: '新建',
      status_resolved: '已解决',
      status_closed: '已关闭',
